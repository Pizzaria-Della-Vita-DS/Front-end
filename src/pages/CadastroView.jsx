...
export default function CadastroView() {
	...
	const handleSubmit = async (e) => {
		...
		const payload = tipo === 'cliente'
			...
			: { ...payloadBase, funcao: form.funcao, rg: form.rg, data_nascimento: form.data_nascimento, setor: form.setor };
			// OBS: o status inicial do funcionário (pendente de aprovação) é definido pelo backend.
		...
		try {
			...
			if (response.ok) {
				if (tipo === 'funcionario') {
					setSucesso('Solicitação enviada! Um gerente precisa aprovar seu cadastro antes do primeiro acesso.');
